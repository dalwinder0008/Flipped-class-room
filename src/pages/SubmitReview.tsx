            ...
            >
              ...
              <div>
                <h2 className="text-3xl font-bold mb-2">
                  {hasSubmitted ? "Review Already Submitted" : "Review Submitted!"}
                </h2>
                <p className="text-slate-400">
                  {hasSubmitted 
                    ? "You have already shared your feedback for this classroom." 
                    : "Your feedback has been analyzed and saved successfully."}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 max-w-sm mx-auto">
                ...
                {!hasSubmitted && (
                  <button 
                    onClick={() => {
                      setStep(1);
                      setFormData({ studentName: user?.displayName || "", email: user?.email || "", rating: 5, content: "" });
                      setResult(null);
                    }}
                    className="text-sm text-slate-500 hover:text-slate-300 transition-colors"
                  >
                    Submit Another (Demo Only)
                  </button>
                )}
              </div>
            </motion.div>
